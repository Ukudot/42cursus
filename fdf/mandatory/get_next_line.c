...
/*   Updated: 2023/03/13 11:57:26 by gpanico          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
char	*ft_strjoin2(char *str, char *buffer, int step)
{
	int		len;
	char	*new;
...
char	*ft_realloc_getb(char *str, char *buffer, int step)
{
	char	*new;
	int		i;
	...
	if (!str)
	{
		...
		new = ft_strjoin2(str, buffer, step);
	return (new);
}
